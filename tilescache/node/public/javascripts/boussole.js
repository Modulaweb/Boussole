			...
			if (p.client.location !== false) {
			    switch (p.client.location) {
			        case 'hotel_de_ville_mtp': 
			            ...
			            break;
			        case 'ot_mtp': 
			            window.boussoleParameters.location = '{"type":"FeatureCollection","features":[{"type":"Feature","properties":{"Selection":0,"location":1,"name":"Office du tourisme","lat":"43.60943456303781","lng":"3.8813474171074485","tags":["specal"],"address":"30 Allée Jean de Lattre de Tassigny<br>34000 Montpellier","phones":["+33 467 60 60 60"],"website":"http://http://ot-montpellier.fr/","Id":"1","icon":"'+boussoleurl+'images/vousetesici.png"},"geometry":{"type":"Point","coordinates":["3.8813474171074485","43.60943456303781"]}}]}';
			            break;
